...
entryTrigger:
新規成行禁止。
ショート候補: 161.245〜161.265付近で上値が重くなり、1分RSIが60前後から反落＋陰線確定、または1分足がEMA短期線を再度下回る場合にショート検討。
ロング候補: 5分MACDが上向きに改善し、161.220〜161.230付近への押し後に反発確認が出るまでは見送り。現状の追い買いは禁止。
...
entryTrigger:
新規成行禁止。
ロング候補: 161.245〜161.255付近への押し目で、5分MACDが上向き転換し、15分MACDの下落が鈍化。そのうえで1分RSI40〜50から反発＋陽線確定なら検討。
ショート候補: 161.265〜161.275付近まで戻した後、15分MACDが下向き継続し、5分MACDが再び弱含み。1分RSI50〜60から反落＋陰線確定なら検討。

cancelCondition:
ロング候補取消: 161.245を明確に割り込み、さらに161.240を下抜ける場合。または5分MACDが下向き継続し、1分RSIが50を下回る場合。
ショート候補取消: 161.275を明確に上抜け、さらに161.290を上抜ける場合。または5分MACDが上向き転換し、1分RSIが50以上でEMA帯を維持する場合。
...
- ショート候補は「161.265〜161.275付近で上値が重くなり、1分RSI50〜60から反落＋陰線確定なら検討」のように書く
- ロング候補は「161.245〜161.255付近の押し目で、1分RSI40〜50から反発＋陽線確定なら検討」のように書く
...
entryTrigger:
ショート候補: 161.265〜161.275付近で上値が重くなり、15分MACDが下向き継続、5分MACDが再び下向きへ失速。そのうえで1分RSI50〜60から反落＋陰線確定なら検討。
...
entryTrigger:
新規成行禁止。
ロング候補: 161.245〜161.255付近で下げ止まり、1分RSI40〜50から反発＋陽線確定。そのうえで5分MACDが上向き転換を維持し、15分MACDの下落が鈍化するなら検討。
ショート候補: 161.265〜161.275付近で上値が重くなり、5分MACDと15分MACDが再び下向きへ揃う。そのうえで1分RSI50〜60から反落＋陰線確定なら検討。
