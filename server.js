...
function applyMxnBelowBuySummaryOverrideV21(next) {
  ...
  next.summary =
    "【V24適用】日足にはまだ長期上昇背景が残るが、4時間足・1時間足・15分足は下向きが強い。現在値は9.258付近で、買サマリ9.267付近を下抜けているため、反発確認前のロングは危険。スワップ目的では押し目候補として監視できるが、短期足の下げ止まり・陽線確定・EMA帯回復を待つ場面。短期RSIは未確認のため、成行ロングは禁止。";
